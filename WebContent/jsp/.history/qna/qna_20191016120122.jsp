...
//         			console.log('b는', b);
		        	...
		        	if (`\${b.qnaPublicEnabled}` == 'N') {
			        	...
			        	if (${sessionScope.user.userNo} != b.userNo && ${sessionScope.user.userGrade} != 3) {
			        		html += `
			        			<h3 class="qna_private">비공개 글입니다.</h3>
			        		`
			        		enabledFlag = true;
			        	}
		        	}	
		        		...
		        		html +=	`<i class="fa fa-lock qna_pd10" style="font-size: 2em" aria-hidden="true"></i>
						   ...
						   <span class="qna_delete_1">
		    		 		...
		    		 		<div class="qna_content_1 hidden" id="c\${b.qnaNo}">	 	
			    		 		<span>공개여부 \${b.qnaPublicEnabled}</span> <span>조회수 \${b.qnaViewCnt}</span>  
...
//         		if(enabledFlag) {
//         				let qna_content = document.getElementById(`c\${b.qnaNo}`);
//         				qna_content.innerHTML = "";
//         		}
				let qnaPrivate = document.querySelectorAll(".qna_private");
				
				for (let i = 0; i < qnaPrivate.length; i++) {
					console.log(qnaPrivate[i]);
					qnaPrivate[i].nth-child(4).innerHTML = "";
