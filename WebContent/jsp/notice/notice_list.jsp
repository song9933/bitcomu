    ...
    pageEncoding="UTF-8"%>
            ...
            <div class="ns_table">
                ...
                <c:forEach var="b" items="${notice}">
                  <li >
                      <span>${b.postNo}</span>
                      <span ><a href="<c:url value="/notice/notice_detail.do?postNo=${b.postNo}&pageNo=${pr.pageNo}&searchType=${search.searchType}&searchWord=${search.searchWord}"/>">${b.title}</a></span>
                      <span>${b.userId}</span>
