...
<body>
		...
		<c:forEach var="b" items="${qna}">
          <div class="qna_accordion vertical" >   	
    		...
    		<i class="fa fa-lock qna_pd10" style="font-size: 2em" aria-hidden="true"></i>
    		 ...
    		 <div class="qna_content_1" id="${b.qnaNo}"> <!-- id 값 동적으로  -->
                        <p>비공개 10분전 조회수 10</p>
                        <p>${b.qnaContent}</p>
                        <p>${b.userId}</p>
  ...
  <form method='post' action="/bitcomu/qna/qnaUpdate.do"> 
    ...
    <div class="qna_update_title">   
      <input type="text" class="qna_text_title_1" name="qnaTitle" style="resize: none" value="${b.qnaTitle}" />
      <input type="checkbox" id="check_0" value="1"><i class="fa fa-lock" style="font-size: 2em" aria-hidden="true"></i>
      <input type="text" class="qna_text_content_1" name="qnaContent" style="resize: none" value="${b.qnaContent}" />
      <ul class="qna_count">
        <p>작성시간 : 10분전    조회수 : 7</p>
      </ul>
      <input type="file" class="qna_update_attatch" enctype="multipart/form-data" name="attach" />
...
<ul class="qna_delete_1">
  ...
  style="font-weight: bold" ></a>
      ...
      <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none'; document.getElementById('fade').style.display='none'" />   <!-- onclick="document.getElementById('light').style.display='none'; document.getElementById('fade').style.display='none'"  -->
          <div class="qna_delete_2"><p>삭제 하시겠습니까?</p></div> 
          <div class="qna_button_1" style="resize: none">
          <div><button type="submit" class="qna_button_0" name="qnaNo">삭제</button></div>
